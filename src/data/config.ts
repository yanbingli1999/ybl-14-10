...
export const GAME_CONFIG = {
  ...
  LOAD_PER_MATCH: 1,
  STAMP_CONSECUTIVE_THRESHOLD: 2,
  STAMP_CANDY_SPAWN_RATE: 0.15,
  STAMP_CANDY_PRIORITY_BONUS: 2,
  LOYALTY_BONUS_THRESHOLD: 3,
  LOYALTY_BONUS_REWARD: 50,
  LOYALTY_BONUS_REPUTATION: 5,
};
